...
BEGIN TRY
	...
	BEGIN
		...
		<div class="govuk-notification-banner__content">
			...
			<p class="govuk-body">Time to celebrate apprenticeships. <a href="https://naw.appawards.co.uk/" target="_blank">Get involved with National Apprenticeship Week</a>.</p>
		</div>
	</div>'
		SET IDENTITY_INSERT [dbo].[Content] OFF
