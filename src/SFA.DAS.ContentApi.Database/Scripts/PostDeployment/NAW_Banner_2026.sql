		...
		SELECT 1,1,
               N'<div class="govuk-notification-banner" role="region" aria-labelledby="govuk-notification-banner-title" data-module="govuk-notification-banner">
                                     ...
                                     <div class="govuk-notification-banner__content">
                                         ...
                                         <p class="govuk-body">National Apprenticeship Week is 9 - 15 February 2026. Get involved and download the toolkit from the <a href="https://naw.appawards.co.uk/" target="_blank" rel="noreferrer">National Apprenticeship Week</a> website.</p>
                                     </div>
